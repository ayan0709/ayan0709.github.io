...
function autoload()
    pcall(function()
        ...
        if exec == "Synapse X" and Settings.AutoLoadScript then
            syn.queue_on_teleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/ayan0709/ayan0709.github.io/master/testing_v2.lua'))()")
        elseif exec ~= "Synapse X" and Settings.AutoLoadScript then
            queue_on_teleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/ayan0709/ayan0709.github.io/master/testing_v2.lua'))()")
        end
    end)
end
...
function autoload2()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/ayan0709/ayan0709.github.io/master/testing_v2.lua'))()
end
if Settings.refarmc then
    autoload2() end
if Settings.setfarm1 then
    ...
    if game.PlaceId == 8304191830 and not Settings.farmprotal and Settings.autostart and Settings.AutoFarm and Settings.teleporting and not Settings.AutoInfinityCastle then
        ...
        elseif cata == "Portals" then
            ...
            elseif level == "portal_item__madoka" then
				for i,v in pairs(GetPortals('portal_item__madoka')) do
